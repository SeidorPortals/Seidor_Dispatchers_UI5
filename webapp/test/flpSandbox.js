		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dispatchers",
									"targetURL": "#comseidorusadispatchers-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comseidorusadispatchers-display": {
								"semanticObject": "comseidorusadispatchers",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.seidor.usa.dispatchers",
									"url": sap.ui.require.toUrl("com/seidor/usa/dispatchers")
								}
							}
						}
					}
