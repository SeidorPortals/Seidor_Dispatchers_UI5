sap.ui.define([
    ...
    return Controller.extend("com.seidor.usa.dispatchers.controller.shipper.ShipperPage", {
        ByDCarrier : "/BYD_QA",
        ...
        onUsageServiceCarrier: function(){
            ...
            jQuery.ajax({
                async: false,
                url: `${this.ByDCarrier}/cust/v1/manageshipper/ZBO_ShipperRootCollection?$format=json`,
                method: "GET",
                dataType : "json",
                headers: {
                ...
                success: function (oData) {
                    that._getModel().setProperty("/mDataShipper",oData.d.results);
                    console.log("OK");
                },
                error: function (err) {
                    console.error(err);
