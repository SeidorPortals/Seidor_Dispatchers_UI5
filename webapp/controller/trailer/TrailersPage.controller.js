sap.ui.define([
    ...
    return Controller.extend("com.seidor.usa.dispatchers.controller.trailer.TrailerPage", {
        ByDCarrier : "/BYD_QA",
        ...
        onUsageServiceCarrier: function(){
           ...
           /* jQuery.ajax({
                async: false,
                url: `${this.ByDCarrier}/cust/v1/manageTrailer/ZBO_TrailerRootCollection?$format=json`,
                method: "GET",
                dataType : "json",
                headers: {
                ...
                success: function (oData) {
                    that._getModel().setProperty("/mDataTrailer",oData.d.results);
                    console.log("OK");
                },
                error: function (err) {
                    console.error(err);
