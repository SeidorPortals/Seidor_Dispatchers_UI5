sap.ui.define([
    ...
    return Controller.extend("com.seidor.usa.dispatchers.controller.CommodityPage", {
        ByDCarrier : "/BYD_QA",
        ...
        onBackReport: function() {
            this._getModel().setProperty("/mPropertyCommodity/vTabAll", true);
            this._getModel().setProperty("/mPropertyCommodity/vTabCreate", false);            
        },
        ...
        onUsageServiceCarrier: function(){
            ...
            jQuery.ajax({
                async: false,
                url: `${this.ByDCarrier}/cust/v1/managecommodities/ZBO_CommodityRootCollection?$format=json`,
                method: "GET",
                dataType : "json",
                headers: {
                ...
                success: function (oData) {
                    that._getModel().setProperty("/mDataCommodity",oData.d.results);
                    console.log("OK");
                },
                error: function (err) {
                    console.error(err);
